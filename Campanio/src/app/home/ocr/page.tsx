...
export default function OCRPage() {
  ...
  const handleScan = async () => {
    ...
    try {
      ...
      const message = "Text reading is unavailable. Check your camera permission and Cloud Vision key, then try again.";
      setScannedText(message);
      setOcrSource("unavailable");
      speak(message, true);
      addToast("Text reading unavailable", "error");
    } finally {
      setIsScanning(false);
    }
  };
