...
export const BottomNavBar: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-30 flex md:hidden justify-center bg-surface border-t-2 border-outline-variant shadow-[0px_-4px_20px_rgba(0,0,0,0.12)] h-[72px] transition-colors">
      <div className="w-full max-w-[480px] mx-auto flex justify-around items-end px-gutter pb-safe h-full">
        {/* Home */}
        <Link
          href="/home"
